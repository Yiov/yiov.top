...
仓库：[https://github.com/whyour/qinglong](https://github.com/whyour/qinglong)
...
[服务器也要放行，在安全组/防火墙里](../ECS/#重置密码及开放端口)
:::
...
访问青龙面板：`http://你的公网ip:端口`

::: tip 说明
比如：[http://192.168.1.1:5700](http://192.168.1.1:5700)
:::
...
::: tip 说明
这里添加后先禁用，了解 [cron定时规则](#_3-2-cron定时规则) 再来改
:::
