    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'iPhone玩机技巧', 
          items: [
            { text: '玩机工具(必看)', link: '/mobile/iPhone/order/' },
            { text: '签名工具', link: '/mobile/iPhone/sign/' },
            { text: '越狱', link: '/mobile/iPhone/jail​break/' },
            { text: 'MDC', link: '/mobile/iPhone/mdc/' },
            { text: 'KFD', link: '/mobile/iPhone/kfd/' },
            { text: '砸壳及注入', link: '/mobile/iPhone/dump/' },
            { text: 'Filza破解', link: '/mobile/iPhone/Filza/' },
            ],
          },
        ],
      },
