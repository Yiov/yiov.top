  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: '手机抓包工具安装及使用', link: '/mobile/capture/' },
          { text: '小米线刷降级破MIUI限制', link: '/mobile/miui/' },
          { text: '小米下载国外版主题并提取', link: '/mobile/mi_theme/' },
          { text: 'iPhone短信添加头像', link: '/mobile/smscard/' },
          { text: '戴口罩解锁iPhone面容ID', link: '/mobile/faceID/' },
          { text: '注册国外苹果Apple_ID步骤', link: '/mobile/Apple_ID/' },
          { text: 'stay2给Safari安装油猴插件', link: '/mobile/stay2/' },
          { text: 'Sideloadly免越狱自签', link: '/mobile/Sideloadly/' },
          { text: '牛蛙助手免越狱虚拟定位/自签', link: '/mobile/bullfrog/' },
          { text: '巨魔助手TrollStore永久免签', link: '/mobile/TrollStore/' },
          { text: '轻松签esign+的安装使用', link: '/mobile/esign/' },
          { text: 'Filza文件管理器破解步骤', link: '/mobile/Filza/' },
          { text: '利用MacDirtyCow无限自签', link: '/mobile/MacDirtyCow/' },
          { text: '苹果iPhone手机越狱教程', link: '/mobile/jail%E2%80%8Bbreak/' },
          { text: 'IOS应用砸壳及插件注入', link: '/mobile/dump/' },
          { text: 'IOS 15越狱工具Dopamine', link: '/mobile/Dopamine/' },
        ],
      },
      {
        //分组标题4
